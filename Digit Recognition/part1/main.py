...
sys.path.append("..")
sys.path.insert(1, 'C:/Users/KT/Tutorial/Python/Machine Learning MITx/Project 2 - Digit Recognition')
from utils import *
...
# TODO: first fill out functions in linear_regression.py, otherwise the
...
def run_softmax_on_MNIST(temp_parameter=1):
    ...
    print('softmax mod3 test_error Using the Current Model =', compute_test_error_mod3(test_x, test_y % 3, theta, temp_parameter))
    return test_error
...
softmax mod3 test_error Using the Current Model = 0.07679999999999998
"""
#######################################################################
# 6.  Changing Labels
#######################################################################
...
def run_softmax_on_PCA(train_pca,test_pca,temp_parameter=1):
...
print("run_softmax_on_PCA error ",run_softmax_on_PCA(train_pca, test_pca))

# TODO: Use the plot_PC function in features.py to produce scatterplot
#       of the first 100 MNIST images, as represented in the space spanned by
#       the first 2 principal components found above.
...
print("run_softmax_on_cube_PCA error",run_softmax_on_PCA(train_cube, test_cube))
...
softmax test_error= 0.10050000000000003
softmax mod3 test_error Using the Current Model = 0.07679999999999998
run_softmax_on_MNIST_mod3 test_error =  0.18720000000000003
run_softmax_on_PCA error  = 0.14739999999999998 (18 Dimensions)
run_softmax_on_PCA error = 0.20589999999999997 (10 Dimensions)
run_softmax_on_cube_PCA error = 0.08489999999999998 (10 Dimensions)
"""
